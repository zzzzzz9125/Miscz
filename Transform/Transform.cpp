...
#define kPluginMaskedName "Mz_TransformMaskedOFX"
...
#define kPluginMaskedIdentifier "net.sf.openfx.MzTransformMaskedPlugin"
...
public:
        ...
        , _srcClipChanged(NULL)
    {
        ...
        assert(_translate && _rotate && _scale && _scaleUniform && _flop && _flip && _skewX && _skewY && _skewOrder && _center && _interactive);
